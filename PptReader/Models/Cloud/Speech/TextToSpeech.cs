...
namespace PptReader.Models.Cloud.Speech
{
    /// <summary>
    ...
    public class Synthesize
    {
        ...
        /// </summary>
        public event EventHandler<AudioAvailabledEventArgs> OnAudioAvailable;
                ...
                async (responseMessage, token) =>
                {
                    try
                    {
                        if (responseMessage.IsCompleted && responseMessage.Result != null && responseMessage.Result.IsSuccessStatusCode)
                        {
                            ...
                            this.AudioAvailable(new AudioAvailabledEventArgs
                            {
                                Stream = httpStream,
        ...
        /// </summary>
        private void AudioAvailable(AudioAvailabledEventArgs e)
        {
        ...
        public class InputOptions
        {
            ...
            {
                this.Locale = "ja-jp";
                this.VoiceName = "Microsoft Server Speech Text to Speech Voice (ja-JP, EkaterinaRUS)";
    ...
    public class AudioAvailabledEventArgs : EventArgs
    {
